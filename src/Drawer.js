            ...
            <main className={classes.content}>
                <div className={classes.toolbar} />
                    <div align="left"  >
                        ...
                        <br/>
                        <Divider/>
                        <OutlinedCard titulo={'Implement Login View'} estado={'In progress'}/>
                        <br/>
                        <Divider/>
                        <OutlinedCard titulo={'Implement Login Controller'} estado={'Ready'}/>
                        <br/>
                        <Divider/>
                        <OutlinedCard titulo={'Facebook Integration'} estado={'Completed'}/>
                        <br/>
                        <Divider/>
                    </div>
            </main>
